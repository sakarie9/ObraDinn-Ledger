...
const showBanner = (message: string, durationMs = 2400) => {
  ...
  banner.style.cssText = [
    ...
    "background: linear-gradient(180deg, #e7dfc9 0%, #d6ccb1 100%)",
    "color: #2b2518",
    ...
    "text-shadow: 0 1px 0 rgba(255, 250, 236, 0.65)",
    "line-height: 1.4",
    "z-index: 9999",
    "box-shadow: 0 3px 0 rgba(43, 37, 24, 0.65), 0 10px 24px rgba(0, 0, 0, 0.32)",
    "background-image: radial-gradient(circle at 18% 22%, rgba(60, 50, 28, 0.1) 0 1.2px, transparent 1.5px), radial-gradient(circle at 78% 64%, rgba(60, 50, 28, 0.08) 0 1px, transparent 1.3px)",
